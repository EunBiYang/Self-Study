...
#시작 시간 정보
start_ticks = pygame.time.get_ticks()  #시작 tick 을 받아온다.
...
while running:
    ...
    #경과시간을 초단위로 바꾸기 위해 천으로 나눔/원래는 밀레세컨즈(ms)

    timer = game_font.render(str(int(total_time - elapsed_time)), True, (225,255,255))
    #출력할 글자 , True, 글자 색상
